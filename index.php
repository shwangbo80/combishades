...
<body>
    ...
    <div class="container px-0">
        <div class="row text-center my-5 py-5">
            <h2 class="display-3 fw-bold text-light-blue">
                Welcome!
            </h2>
            <div class="d-flex justify-content-center">
                <h2 class="ms-0 px-0 my-5">
                    Combi Shade<sup class="me-2">&reg;</sup>brings innovative styling and<br>revolutionary design
                    concepts<br>for your window shading systems!
                </h2>
            </div>
            <p>
                Combi Shade<sup class="me-2">&reg;</sup>products combines innovation and quality to your home
                decorations.
            </p>
            <a href="#contact">
                <button class="bg-light-blue start-now-btn">
                    <p class="m-0 text-light">START NOW</p>
                </button>
            </a>
            <h4>
                <a href="./child-safety.php">
                    <i class="icon-right-open"></i>
                    Read about our cord-free solutions for child safety.
                </a>
            </h4>
        </div>
    </div>
    ...
    <div class="container-fluid bg-light-gray">
        <div class="row text-center my-5 py-5">
            <div class="col-md-4 mt-5">
                <img class="image-fluid" src="./img/home-design.png" />
                <h4 class="mt-4">
                    Innovative Home<br>
                    Decoration Styles
                </h4>
            ...
            <div class="col-md-4 my-5">
                <img class="image-fluid" src="./img/business-partner.png" />
                <h4 class="mt-4">
                    Key To Success For Our<br>
                    Fabricator Partners
                </h4>
            </div>
            <div class="col-md-4 mt-5">
                <img class="image-fluid" src="./img/window-blind.png" />
                <h4 class="mt-4">
    ...
    <div class="container px-0 mb-5">
        <div class="row text-center my-5 p-5">
            <div class="d-flex flex-column align-items-center">
                <h2 class="text-center text-olive fw-bold">
                    Step 1
                </h2>
                <h2 class="text-light-blue fw-bold">
                    CALL US OR<br>SEND US AN EMAIL
                </h2>
                <div class="col-md-4">
                    <p>
                        First step in becoming our fabricator partner is to contact us. We are ready to answer on your
                        questions how we can work together as a team to build a sustainable business.
                    </p>
                </div>
            </div>

            <div class="list_left list_icon text-center">
                <i class="icon-down-bold arrow-icon text-light-blue"></i>
            </div>
            ...
            <div class="d-flex flex-column align-items-center">
                ...
                <div class="col-md-4">
                    <h2 class="text-light-blue fw-bold">
                        APPLY TO BECOME OUR<br>FABRICATOR PARTNERS
                    </h2>
                </div>
                <div class="col-md-4">
                    <p>
                        You’re just one short step away from launching your new profitable program. Please keep in mind
                        that the faster you get started, the faster you can begin building your business.
                    </p>
                </div>
            </div>
            ...
            <div class="d-flex flex-column align-items-center">
                ...
                <div class="col-md-4">
                    <h2 class="text-light-blue fw-bold">
                        EMBARK ON A SUCCESSFUL PROGRAM BY COLLABORATING
                    </h2>
                </div>
                <div class="col-md-4">
                    <p>
    ...
    <div class="my-5 text-center bg-light-gray product-container">
        <h1 class="title text-olive mb-5">
            OUR PRODUCTS
        </h1>
        <div class="row">
