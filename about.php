    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-10 my-5">
                <div class="row">
                    <div class="col-sm-4">
                        <img class="img-fluid d-block" src="./img/about_img_1.jpg" />
                    </div>
                    <div class="col-sm-8 ps-0 ps-md-5">
                        <h2 class="fw-bold text-olive mt-5 mt-md-0 mb-sm-0 mb-md-4">
...
<span class=" fst-italic fw-bold">support@combishades.com</span>
                ...
                <div class=" row my-5">
                    <div class="col-md-4">
                        <img class="img-fluid" src="./img/about_img_2.jpg" />
                    </div>
                    <div class="col-md-4 my-5 my-md-0">
                        <img class="img-fluid" src="./img/about_img_3.jpg" />
                    </div>
                    <div class="col-md-4">
                        <img class="img-fluid" src="./img/about_img_4.jpg" />
                    </div>
                </div>
            </div>
            <div class="col-md-1"></div>
