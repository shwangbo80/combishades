...
if (array_key_exists('email', $_POST)) {
    ...
    $mail->setFrom('shwangbo80@gmail.com', 'First Last');
    ...
    $addresses = [
        'sales' => 'shwangbo80@gmail.com',
        'support' => 'shwangbo80@gmail.com',
        'accounts' => 'shwangbo80@gmail.com',
    ];
    ...
    if (array_key_exists('dept', $_POST) && array_key_exists($_POST['dept'], $addresses)) {
        ...
        $mail->addAddress('shwangbo80@gmail.com');
    }
