            ...
            <div class="col-md-5">
                <div class="tab-content">
                    <div class="tab-pane fade show active etab-p1">
                        <img class="img-fluid fabric-img" src="../../img/fabrics/roller-shade/omega/om-301-white.jpg" />
                    </div>
                    <div class="tab-pane fade etab-p2">
                        <img class="img-fluid fabric-img"
                            src="../../img/fabrics/roller-shade/omega/om-302-whiteivory.jpg" />
                    </div>
                    <div class="tab-pane fade etab-p3">
                        <img class="img-fluid fabric-img"
                            src="../../img/fabrics/roller-shade/omega/om-303-whitegrey.jpg" />
                    </div>
                    <div class="tab-pane fade etab-p4">
                        <img class="img-fluid fabric-img" src="../../img/fabrics/roller-shade/omega/om-304-ivory.jpg" />
                    </div>
                    <div class="tab-pane fade etab-p5">
                        <img class="img-fluid fabric-img"
                            src="../../img/fabrics/roller-shade/omega/om-308-blackbronze.jpg" />
                    </div>
                    <div class="tab-pane fade etab-p6">
                        <img class="img-fluid fabric-img"
                            src="../../img/fabrics/roller-shade/omega/om-310-blackgrey.jpg" />
                    </div>
                    <div class="tab-pane fade etab-p7">
                        <img class="img-fluid fabric-img" src="../../img/fabrics/roller-shade/omega/om-311-black.jpg" />
                    </div>
                        ...
                        <div class="col-2">
                            <a class="active show" href="#tab-1" data-bs-target=".etab-p1, .etabi-img1"
                                ...
                                <img class="img-fluid fabric-thumb" id="fabric-1"
                                    src="../../img/fabrics/roller-shade/omega/om-301-white.jpg" />
                            </a>
                        </div>
                        <div class="col-2">
                        ...
                        <div class="col-2">
                            <a href="#tab-4" data-bs-target=".etab-p4, .etabi-img4" data-bs-toggle="tab">
                                <img class="img-fluid fabric-thumb" id="fabric-4"
                                    src="../../img/fabrics/roller-shade/omega/om-304-ivory.jpg" />
                            </a>
                        </div>
                        <div class="col-2">
                            ...
                            <div class="col-2">
                                <a href="#tab-7" data-bs-target=".etab-p7, .etabi-img7" data-bs-toggle="tab">
                                    <img class="img-fluid fabric-thumb" id="fabric-7"
                                        src="../../img/fabrics/roller-shade/omega/om-311-black.jpg" />
                                </a>
                            </div>
                        </div>
                    </div>
